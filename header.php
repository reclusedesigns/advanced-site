      ...
      <div class="container">
        <a class="brand" href="index">Advanced Property Construction</a>
				<ul class="nav pull-right">
					...
					<li class="<?php echo ($page_name=='pages/process.php')?'active':'';?>"><a href="process" class="process">Process</a></li>
					<li <?php echo ($page_name=='projects.php')?'active':'';?>><a href="projects" class="projects">Projects</a></li>
