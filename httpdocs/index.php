<?php include 'header.php'; ?>
	...
	<section class="body">
		<div class="container">
			<div class="row">
				<div class="span4">
					<div class="developed">
						<h4>Developed in Development</h4>
				...
				<div class="span3">
					<div class="testimonials_home">
						<img src="design/images/body/home/arrow.png">	
						<p>"We were amazed at the level of quality APC provided AND they handed over the keys ahead of schedule!"</p>
						<p class="name">Pawel Bankowski</p>
					</div> <!-- testimonials -->
				</div> <!-- span3 -->
				<div class="span5">
	...
	<div class="container">
		<section class="from_here well">
			<h4>I think we should talk. <strong>Call us on (03) 9379 9935</strong></h4>
		</section>
	</div>
